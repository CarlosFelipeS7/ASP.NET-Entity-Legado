...
{
    /// <inheritdoc />
    public partial class initial : Migration //migration é o codigo csharp que cria o banco de dados
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder) //up é o que vai subir para o banco de dados ao realizar o update-database
        {
